...
def log_food(item: str) -> str:
    """Log a meal or food item."""   # <- docstring added
...
def log_water(amount: str) -> str:
    """Log water intake in cups or ml.""" 
...
@tool
def get_summary() -> str:
    """Log summary of all logged lifestyle data """ 
...
# Add this line so agent.py can import the tools list
